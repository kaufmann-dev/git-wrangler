...
order: 1
usage: "git-wrangler rewrite-authors --name <new_name> --email <new_email> [--yes] [--force] [--repo <repository_name>]"
---
...
```bash
git-wrangler rewrite-authors --name <new_name> --email <new_email> [--yes] [--force] [--repo <repository_name>]
```
